...
{
    /// <summary>
    ///     Wrapper class to work with the RoboFarmPLC IoT device.
    ...
    /// </summary>
    public class RoboFarmPLC : IFarmAutomationDevice
    {
        ...
        /// <summary>
        ///     This is a private activation key and should not be exposed to the outside world
        /// </summary>
        ...
        /// </summary>
        public string Manufacturer => "intelligent Farming Ltd";

        /// <summary>
        ///     Name of this automation IoT device
        /// </summary>
        public string Name => nameof(RoboFarmPLC);
